...
def find_median(seq):
    ...
    Extracts items until it reaches the median item
    :param seq: an iterable sequence
    ...
    min_heap.extend(seq)  # build min heap

    itr = min_heap.length // 2  # location of median item
    while itr != 0:
        min_heap.extract()  # extracts to middle item
        itr -= 1
